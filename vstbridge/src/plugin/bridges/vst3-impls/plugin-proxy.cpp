 ...
 * we'll first try to bypass that proxy. This goes against the idea of vstbridge,
 ...
 */
constexpr char other_instance_message_id[] = "vstbridge_other_instance";
/**
...
tresult PLUGIN_API Vst3PluginProxyImpl::setProcessing(TBool state) {
    ...
    // we sadly have to deviate from vstbridge's principles and implement a
...
tresult PLUGIN_API Vst3PluginProxyImpl::connect(IConnectionPoint* other) {
    ...
    // against the principles of vstbridge, but the alternative is nearly
