 ...
 * hosted in our Wine plugin host. This works in the same way as vstbridge's VST3
 ...
 * even with vstbridge's 'individual' plugin hosting other instances of the same
...
class ClapPluginBridge : PluginBridge<ClapSockets<std::jthread>> {
   public:
    ...
    /**
     * The logging facility used for this instance of vstbridge. Wraps around
