 ...
 */
constexpr char disable_watchdog_timer_env_var[] = "VSTBRIDGE_NO_WATCHDOG";

/**
 * If this environment variable is set, vstbridge will store its sockets and
 ...
 */
constexpr char temp_dir_override_env_var[] = "VSTBRIDGE_TEMP_DIR";
