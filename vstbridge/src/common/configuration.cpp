...
Configuration::Configuration(const fs::path& config_path,
    ...
    // This is the path of the current .so file relative to this `vstbridge.toml`
    // file
    const fs::path relative_path =
        plugin_path.lexically_relative(config_path.parent_path());
