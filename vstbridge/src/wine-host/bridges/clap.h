...
#ifndef CLAP_ABI
#error The found CLAP dependency does not declare a calling convention on Windows. Building vstbridge against these CLAP headers will cause it to malfunction.
#endif
...
class ClapBridge : public HostBridge {
   public:
     ...
     *   load. In vstbridgectl we'll create symlinks to these using a `.clap-win`
   ...
   public:
    ...
    /**
     * The configuration for this instance of vstbridge based on the path to the
